...
import com.ram.www.exception.ResourceNotFoundException;
import com.ram.www.model.Employee;
import com.ram.www.repo.EmployeeRepository;
	...
	public class EmployeeService 
	{
		...
		public Employee getEmployeeById(Long id) {
			return employeeRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("Id Not Foud"));
		}
